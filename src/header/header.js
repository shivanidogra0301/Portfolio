        ...
        <div className="header">
            ...
            <div className="main">
                ...
                <div className="heading2">
                    <span className="heading2-primary">Shubham</span>
            ...
            <div className="icons_box">
                    ...
                    <a className="icon_box" target="_blank" href='mailTo:shubhamdogra076@gmail.com'>
                ...
                <a className="icon_box" target="_blank" href="https://github.com/ShubhamDogra112">
                    ...
                    <a className="icon_box" target="_blank" href="https://www.linkedin.com/in/shubham-dogra-25951b194">
                        <svg className="icon" viewBox="0 0 32 32">
