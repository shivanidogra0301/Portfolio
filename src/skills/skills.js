    ...
    return (
        <div ref={props.refs} className={classes.skills}>
            <div className={classes.header}>
                ...
                <span style={{color:"#ededed", fontWeight:"700"}}> Skills</span>
            </div>
