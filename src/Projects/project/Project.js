		...
		return (
			<div className={classes.project}>
				<div className={classes.image}>
					...
					{/* <a  className={classes.icon} href="https://github.com/ShubhamDogra112">
                            <svg className={classes.icon__github} viewBox="0 0 32 32">
					...
					{this.props.title === 'Whatsapp-Clone' ? (
						<span>
							Click <a style={{
                                ...
                                color:"#212121",
                                outline:'none'
                            }} href="https://whatsapp-clone-112.netlify.app">here</a> to view the ptoject
						</span>
					) : null}

                {this.props.title === 'Redsapp' ? (
						<span>
							Click <a style={{
                                textDecoration:'none',
                                fontWeight:'bold',
